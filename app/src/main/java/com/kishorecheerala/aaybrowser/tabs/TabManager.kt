package com.kishorecheerala.aaybrowser.tabs
...
import com.kishorecheerala.aaybrowser.ui.adapters.TabAdapter
import com.kishorecheerala.aaybrowser.web.BrowserCallbacks
import com.kishorecheerala.aaybrowser.web.configureWebView
...
data class BrowserTab(
    ...
    val speechBridge: com.kishorecheerala.aaybrowser.web.SpeechRecognitionBridge,
...
class TabManager(
    ...
    fun createBrowserTab(initialUrl: String?, initialTitle: String = "", activate: Boolean): BrowserTab? {
        ...
        val speechBridge = com.kishorecheerala.aaybrowser.web.SpeechRecognitionBridge(tabView) { pageUrl ->
    ...
    private fun setupWebMessageListener(webView: android.webkit.WebView, speechBridge: com.kishorecheerala.aaybrowser.web.SpeechRecognitionBridge) {
        if (WebViewFeature.isFeatureSupported(WebViewFeature.WEB_MESSAGE_LISTENER)) {
            WebViewCompat.addWebMessageListener(webView, com.kishorecheerala.aaybrowser.web.SpeechRecognitionBridge.BRIDGE_OBJECT_NAME, setOf("*")) { webViewInstance, message, sourceOrigin, isMainFrame, _ ->
