...
import com.kishorecheerala.aaybrowser.settings.SettingsCallbacks
import com.kishorecheerala.aaybrowser.settings.SettingsViews
import com.kishorecheerala.aaybrowser.startpage.StartPageManager
import com.kishorecheerala.aaybrowser.tabs.TabManager
import com.kishorecheerala.aaybrowser.web.updatePageDarkening
...
class OverlayManager(
    ...
    fun showCheckLatestView() {
        ...
        binding.checkLatestInstalledVersion.text = activity.getString(
            ...
            "v${com.kishorecheerala.aaybrowser.BuildConfig.VERSION_NAME}"
        )
            ...
            try {
                ...
                if (conn.responseCode == 200) {
                    ...
                    activity.runOnUiThread {
                        ...
                        val currentVer = com.kishorecheerala.aaybrowser.BuildConfig.VERSION_NAME.trim().removePrefix("v")
