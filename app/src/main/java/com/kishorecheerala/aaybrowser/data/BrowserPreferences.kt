package com.kishorecheerala.aaybrowser.data
...
import com.kishorecheerala.aaybrowser.model.AppThemeMode
import com.kishorecheerala.aaybrowser.model.QuickActionButtonMode
import com.kishorecheerala.aaybrowser.model.QuickActionButtonPosition
...
object BrowserPreferences {
    ...
    fun isAdBlockerEnabled(context: Context): Boolean {
        return context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
            .getBoolean(KEY_AD_BLOCKER_ENABLED, true)
    }

    fun setAdBlockerEnabled(context: Context, enabled: Boolean) {
        context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
            .edit()
            .putBoolean(KEY_AD_BLOCKER_ENABLED, enabled)
            .apply()
    }
